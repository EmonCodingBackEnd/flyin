...
<dependency>
    ...
    <version>3.9.1</version><!-- 需要替换为最新版本 -->
</dependency>
```
...
# 自定义日志打印
#logMessageFormat=com.coding.fly.site.admin.common.P6spyLogFormat
logMessageFormat=com.p6spy.engine.spy.appender.CustomLineFormat
customLogMessageFormat=category: %(category), connectionId: %(connectionId), elapsed: %(executionTime) ms, exec sql: %(sqlSingleLine)
# 使用日志系统记录sql
...
#
# ==================================================华丽的分割线之自定义日志格式==================================================
#package com.coding.fly.site.admin.common;
#
